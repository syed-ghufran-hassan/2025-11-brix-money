...
contract DeployCore is Script, DeploymentRegistry {
    ...
    bytes32 internal constant CREATE2_FACTORY_SALT = keccak256("itry.factory.vFinal");
    bytes32 internal constant ORACLE_SALT = keccak256("itry.oracle.vFinal");
    bytes32 internal constant DLF_TOKEN_SALT = keccak256("itry.dlf.vFinal");
    bytes32 internal constant ITRY_IMPL_SALT = keccak256("itry.token.impl.vFinal");
    bytes32 internal constant ITRY_PROXY_SALT = keccak256("itry.token.proxy.vFinal");

    function run() public {
        console2.log("========================================");
        console2.log("10_DeployCore: Starting Core Deployment (vFinal)");
        console2.log("========================================");
