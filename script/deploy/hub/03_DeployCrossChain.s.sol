 ...
 * - Grants COMPOSER_ROLE to wiTryVaultComposer on StakediTryCrosschain
 * - Sets LayerZero delegates to deployer (required for library configuration)
 *
...
contract DeployCrossChain is Script, DeploymentRegistry {
    ...
    bytes32 internal constant COMPOSER_ROLE = keccak256("COMPOSER_ROLE");

    function run() public {
        console2.log("=========================================");
        console2.log("03_DeployCrossChain: Starting CrossChain Deployment (v2)");
        console2.log("=========================================");
        ...
        require(registryExists(), "Core/Protocol contracts not deployed. Run 01 and 02 first.");
        ...
        addrs.wiTryVaultComposer = address(vaultComposer);
        ...
        console2.log("VAULT_COMPOSER:", address(vaultComposer));
        console2.log("=========================================");
        console2.log("");
        console2.log("NEXT STEPS:");
        console2.log("1. Deploy spoke chain contracts");
        console2.log("2. Configure peers bidirectionally");
        console2.log("3. Set LayerZero libraries");
        console2.log("=========================================");
    }
