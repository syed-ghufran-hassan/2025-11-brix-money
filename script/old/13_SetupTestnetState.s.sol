 ...
 * 2. Distribute DLF collateral to all test actors
 * 3. Whitelist actors on iTryIssuer
 * 4. Each actor mints iTRY tokens
 * 5. Stakers stake iTRY to get wiTRY shares
 * 6. Validate final system state
 *
 * Key changes from v1 (04_SetupState):
 ...
 *
 * Deployment sequence: 10 → 11 → 13 (optional) → 12
 */
contract SetupTestnetState is Script, DeploymentRegistry {
    ...
    function run() public {
        console2.log("=========================================");
        console2.log("13_SetupTestnetState: Starting Testnet State Setup");
        console2.log("=========================================");
        ...
        require(registryExists(), "Contracts not deployed. Run 10 and 11 first.");
        ...
        console2.log("1. Run 12_DeployCrossChain.s.sol to deploy crosschain infrastructure");
        console2.log("2. Run 40_VerifyHub.s.sol to verify deployment");
        console2.log("=========================================");
    }
    ...
    function _verifyDeployments(DeploymentAddresses memory addrs) internal view {
        ...
        require(addrs.staking != address(0), "StakediTry not deployed");
